-- RPC to seed mock data for the CURRENT user/clinic
...
BEGIN
  ...
  IF loc IS NULL THEN
    INSERT INTO locations (clinic_id, nome, tipo) VALUES (clinic, 'Matriz', 'matriz') RETURNING id INTO loc;
  END IF;
